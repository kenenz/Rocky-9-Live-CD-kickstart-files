...
repo --name=baseos --mirrorlist=https://mirrors.rockylinux.org/mirrorlist?arch=x86_64&repo=BaseOS-9
repo --name=appstream --mirrorlist=https://mirrors.rockylinux.org/mirrorlist?arch=x86_64&repo=AppStream-9
repo --name=epel --mirrorlist=https://mirrors.fedoraproject.org/mirrorlist?repo=epel-9&arch=x86_64&country=US


#################################REPOS THAT FAIL
###repo --name=rpmfusionfree --baseurl=http://mirrors.rpmfusion.org/mm/publiclist/RPMFUSIONfreeEL/9/x86_64/
###repo --name="rpmfusion nonfree" --baseurl=http://mirrors.rpmfusion.org/mm/publiclist/RPMFUSIONnonfreeEL/9/x86_64/
##################################################
